...
genFloPoCoInfoEntity :: 
   String -- ^ path where FloPoCo is built or installed
   -> [String] -- ^ input to feed FloPoCo 
   -> String -- ^ Path to the VHDL file generated by FloPoCo
   -> Q Exp 
...
-- 
flopocoPrim :: 
   Name -- ^ Name of the Clash function corresponding to entity(VHDL) or module(Verilog, SystemVerilog) 
   -> Name -- ^ Name of BlackBox function of the Clash function
   -> Primitive
