...
import GenTemDSL(getPipeDep, flopocoPrim, genBlackBoxFunction, genTemplateFunction, genBlackBoxTemplateFunction, genBlackBoxTemplateFunctionProd,genBlackBox, genBlackBoxProd)
